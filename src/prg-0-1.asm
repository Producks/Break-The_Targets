...
; Global function for both menu
.include "src/menu/global-menu-func.asm"

; Title screen overhaul, see files for code
.include "src/menu/title_screen_gfx.asm"
.include "src/menu/title_screen.asm"
...
DumpHudAreaBuffer:
  .db $27, $2E, $06, $01, $01, $01, $01, $01, $01
  .db $27, $37, $08, $01, $01, $01, $01, $01, $01, $01, $01
  .db $27, $77, $08, $01, $01, $01, $01, $01, $01, $01, $01
  .db $00

DumpHudAreaBufferInRAM:
  LDY #$00
DumpHudAreaBufferInRAMLoop:
  LDA DumpHudAreaBuffer, Y
  STA PPU_UpdateAreaHudeBuffer, Y
  INY
  CPY #$20
  BNE DumpHudAreaBufferInRAMLoop
  RTS

PPUBuffer_DumpHud:
  .db $27, $46, $02, $DF, $DF ; Target count
  .db $27, $50, $02, $DF, $DF ; Restriction count
  .db $00
...
LoadCurrentAreaHud:
  LDA #ScreenUpdateBuffer_UpdateAreaHud
  STA ScreenUpdateIndex

  LDX CurrentLevelArea
  LDA AreaHudRestrictionPTRLo, X
  STA TempAdrLo
  LDA AreaHudRestrictionPTRHi, X
  STA TempAdrHi

  LDY #$00
TextRestrictionName:
  LDA (TempAdrLo), Y
  STA PPU_UpdateAreaHudeBuffer + 3, Y
  INY
  CPY #$06
  BNE TextRestrictionName

  LDA LevelNameHudPTRLo, X
  STA TempAdrLo
  LDA LevelNameHudPTRHi, X
  STA TempAdrHi

  LDY #$00
UpperHudLevelNameLoop:
  LDA (TempAdrLo), Y
  STA LevelTextUpper, Y
  INY
  CPY #$08
  BNE UpperHudLevelNameLoop

DownHudLevelNameLoop:
  LDA (TempAdrLo), Y
  STA LevelTextBottom - 8, Y
  INY
  CPY #$10
  BNE DownHudLevelNameLoop
